...
Get-AzResource | Select-Object Name, ResourceType, ResourceGroupName, Location, Tags | Export-Csv -Path "AzureAssetInventory.csv"
...
|---------|---------------|----------------|--------|
| A.5.1.1 | Azure Policy | Security policy enforcement | Pending |
| A.8.1.1 | Azure Resource Graph | Asset inventory management | Pending |
| A.9.1.1 | Azure AD + RBAC | Access control implementation | Pending |
| A.10.1.1 | Azure Key Vault | Cryptographic key management | Pending |
| A.12.6.1 | Azure Monitor | Security monitoring and logging | Pending |
| A.13.1.1 | Azure Firewall + NSG | Network access control | Pending |
| A.16.1.1 | Azure Sentinel | Incident detection and response | Pending |
| A.17.1.1 | Azure Site Recovery | Business continuity planning | Pending |
