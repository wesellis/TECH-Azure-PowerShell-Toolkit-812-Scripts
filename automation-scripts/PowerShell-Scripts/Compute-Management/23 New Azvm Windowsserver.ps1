...
<#
.SYNOPSIS
    We Enhanced 23 New Azvm Windowsserver
...
[hashtable]$WETags = @{
    ...
    " Application"     = 'Exchange Server 2019'  
    " Purpose"         = 'Lions House Exchange Hybrid Test env'
    " Uptime"          = '24/7'
    " Workload"        = 'Exchange Server and AD'
