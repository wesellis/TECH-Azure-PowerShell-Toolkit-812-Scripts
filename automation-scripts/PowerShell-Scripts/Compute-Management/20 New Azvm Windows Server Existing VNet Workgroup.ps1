...
.SYNOPSIS
    20 New Azvm Windows Server Existing Vnet Workgroup
...
<#
.SYNOPSIS
    We Enhanced 20 New Azvm Windows Server Existing Vnet Workgroup
...
$WEVnetName = 'CCI_ESMC_RG-vnet'
$WESubnetName = 'default'
