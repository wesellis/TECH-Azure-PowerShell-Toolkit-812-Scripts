...
.SYNOPSIS
    23 New Azvm Windowsserver Workgroup With New Vnet
...
<#
.SYNOPSIS
    We Enhanced 23 New Azvm Windowsserver Workgroup With New Vnet
...
$WEVMSize = " Standard_B2S" # 1vCPUs and 2GB of RAM
