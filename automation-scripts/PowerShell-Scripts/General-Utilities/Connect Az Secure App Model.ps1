...
$newPartnerAccessTokenSplat_azureToken_3001 = @{
    ApplicationId    = $WEAppcredential_3001.UserName
    Credential       = $WEAppcredential_3001
    RefreshToken     = $WERefreshToken_3001 #comment out if you are usnig the UseAuthorizationCode parameter
    Scopes           = 'https://management.azure.com/user_impersonation'
    ServicePrincipal = $true
    Tenant           = $WETenantID_3001
...
$newPartnerAccessTokenSplat_graphToken_3001 = @{
    ApplicationId    = $WEAppcredential_3001.UserName
    Credential       = $WEAppcredential_3001
    RefreshToken     = $WERefreshToken_3001
