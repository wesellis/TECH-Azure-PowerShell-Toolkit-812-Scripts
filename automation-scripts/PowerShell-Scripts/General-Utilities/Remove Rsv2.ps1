...
$WEVaultName = " FGC-Azure-Prod-Recovery-Services-Vault-004" #fetch automatically
$WESubscription = " Microsoft Azure - FGC Production - ACTIVE" #fetch automatically
$WEResourceGroup = " 004-FGC-Azure-Prod-Recovery-services-Vault-Rg" #fetch automatically
$WESubscriptionId = " 3532a85c-c00a-4465-9b09-388248166360" #fetch automatically
