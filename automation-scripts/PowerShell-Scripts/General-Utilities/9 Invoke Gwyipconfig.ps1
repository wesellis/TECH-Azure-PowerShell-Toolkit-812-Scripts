...
<#
.SYNOPSIS
    We Enhanced 9 Invoke Gwyipconfig
...
[CmdletBinding()]
function WE-Invoke-AzVirtualNetworkGatewayIpConfig {
    [CmdletBinding()]
...
param(
    ...
    process {
        ...
        try {
           ...
           ;  $WEGatewayPublicIPConfig = New-AzVirtualNetworkGatewayIpConfig -ErrorAction Stop @newAzVirtualNetworkGatewayIpConfigSplat
        ...
        return $WEGatewayPublicIPConfig
