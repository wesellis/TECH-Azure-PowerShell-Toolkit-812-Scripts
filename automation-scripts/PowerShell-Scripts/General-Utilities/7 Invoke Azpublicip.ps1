...
<#
.SYNOPSIS
    We Enhanced 7 Invoke Azpublicip
...
param(
    ...
    process {
        ...
        try {
           ...
           ;  $WEPublicIPConfig = New-AzPublicIpAddress -ErrorAction Stop @newAzPublicIpAddressSplat
