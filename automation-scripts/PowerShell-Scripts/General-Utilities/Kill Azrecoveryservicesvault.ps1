...
Write-Information $response.StatusCode
...
$fabricObjects = Get-AzRecoveryServicesAsrFabric -ErrorAction Stop # context must already be set (and should be above)
