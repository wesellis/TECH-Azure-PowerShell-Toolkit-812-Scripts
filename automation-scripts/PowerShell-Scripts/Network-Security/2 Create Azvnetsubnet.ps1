...
.OUTPUTS
    ...
    General notes
[CmdletBinding()]
function Invoke-CreateAZVNETSubnet {
    [CmdletBinding()]
function Write-Host {
    param(
        [Parameter()]
...
param(
    ...
    process {
        try {
$SubnetConfig = New-AzVirtualNetworkSubnetConfig -ErrorAction Stop @newAzVirtualNetworkSubnetConfigSplat
...
$ErrorMessage_1 = $_.Exception.Message
        ...
        return $SubnetConfig
        # $SubnetConfig | Invoke-DefineParam
    }
}
