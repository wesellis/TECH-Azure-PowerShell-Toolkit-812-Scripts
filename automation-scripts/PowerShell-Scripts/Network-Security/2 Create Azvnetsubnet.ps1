...
<#
.SYNOPSIS
    We Enhanced 2 Create Azvnetsubnet
...
[CmdletBinding()]
function WE-Invoke-CreateAZVNETSubnet {
    [CmdletBinding()]
...
param(
    ...
    process {
        ...
        try {
           ...
           ;  $WESubnetConfig = New-AzVirtualNetworkSubnetConfig -ErrorAction Stop @newAzVirtualNetworkSubnetConfigSplat
            

            # $WEVNET | Set-AzVirtualNetwork -ErrorAction Stop
        }
        ...
        return $WESubnetConfig
        # $WESubnetConfig | Invoke-DefineParam
