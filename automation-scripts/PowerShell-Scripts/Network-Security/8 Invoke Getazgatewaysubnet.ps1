...
<#
.SYNOPSIS
    We Enhanced 8 Invoke Getazgatewaysubnet
...
[CmdletBinding()]
function WE-Invoke-GetAZGatewaysubnet {
    [CmdletBinding()]
...
param(
    ...
    process {
        ...
        try {
           ...
           ;  $WEGatewaySubnetConfig = Get-AzVirtualNetworkSubnetConfig -ErrorAction Stop @GetAzVirtualNetworkSubnetConfigsplat
