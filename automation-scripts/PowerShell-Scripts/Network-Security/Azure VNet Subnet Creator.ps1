...
<#
.SYNOPSIS
    We Enhanced Azure Vnet Subnet Creator
...
Write-WELog " Subnet added successfully:" " INFO"
Write-WELog "  Subnet: $WESubnetName" " INFO"
Write-WELog "  Address: $WEAddressPrefix" " INFO"
Write-WELog "  VNet: $WEVNetName" " INFO"
