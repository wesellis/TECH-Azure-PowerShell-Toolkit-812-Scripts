...
function Test-NetworkSegmentation {
    ...
    foreach ($vnet in $vnets) {
        ...
        $segmentationIssues += $vnetAnalysis
    }
...
function Test-IdentityPerimeter {
    ...
    foreach ($storage in $storageAccounts) {
        ...
        $identityIssues += $storageAnalysis
    }
...
function Test-MicroSegmentation {
    ...
    foreach ($nsg in $nsgs) {
        ...
        $microSegmentationIssues += $nsgAnalysis
    }
...
# Generated: $(Get-Date)
# Subscription: $($AssessmentResults.SubscriptionId)

# 1. Network Segmentation Remediation
"@
...
# Create and associate NSG for subnet: $($subnet.Name)
...
<body>
    ...
    <div class="summary">
        ...
        <p>Your environment's Zero Trust Network maturity level: $(
            if ($AssessmentResults.OverallScore -ge 80) { "Advanced" }
