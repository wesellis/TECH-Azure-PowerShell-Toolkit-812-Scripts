...
$SFSecretValue = Read-Host -Prompt "Enter secure value" -AsSecureString
...
$sshPublicKeyValue = Read-Host -Prompt "Enter secure value" -AsSecureString
Set-AzureKeyVaultSecret -VaultName $KeyVaultName -Name $sshPublicKeySecretName -SecretValue $sshPublicKeyValue -Verbose
$sshPrivateKeyValue = Read-Host -Prompt "Enter secure value" -AsSecureString
...
Export-PfxCertificate -Cert $NewCert -FilePath " $pfxFileFullPath" -Password $(Read-Host -AsSecureString -Prompt "Enter secure value"
Export-Certificate -Cert $NewCert -FilePath " $cerFileFullPath"
$kvCert = Import-AzureKeyVaultCertificate -VaultName $KeyVaultName -Name " azbot-ssl-cert" -FilePath $pfxFileFullPath -Password $(Read-Host -AsSecureString -Prompt "Enter secure value"
