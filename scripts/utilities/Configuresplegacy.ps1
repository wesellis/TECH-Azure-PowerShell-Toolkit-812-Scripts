...
#Requires -Modules ComputerManagementDsc, NetworkingDsc, ActiveDirectoryDsc, WebAdministrationDsc, SharePointDsc, DnsServerDsc, CertificateDsc, SqlServerDsc, cChoco

<#
.SYNOPSIS
    Configure SharePoint VM (Legacy)

.DESCRIPTION
    Azure DSC configuration for SharePoint VM setup in legacy mode
...
configuration ConfigureSPVM
{
    ...
    Node localhost
    {
        ...
        SPWebApplication MainWebApp
        {
            ...
            DatabaseName = $SPDBPrefix + "Content"
